    ...
    const properties = [
        {
          ...
          options: [
            ...
            { name: 'Update', value: 'update', description: 'Update a specific address', action: 'Update' },
            { name: 'Delete', value: 'delete', description: 'Delete a specific address', action: 'Delete' },
          ],
          default: 'get',
