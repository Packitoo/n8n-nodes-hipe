...
export const properties: INodeProperties[] = [
  ...
  },
  {
    ...
    options: [
      ...
      // Add any additional filters for listing corrugated suppliers
    ],
  },
  {
    displayName: 'Sort',
...
export async function execute(
  ...
  for (let i = 0; i < items.length; i++) {
    try {
      ...
      // In the actual implementation, this would make an API call to list corrugated suppliers
      ...
      returnData.push({
        json: {
          ...
          data: [
            {
              id: '1',
              name: 'Sample Corrugated Supplier 1',
              contactInfo: 'Contact info for supplier 1',
            },
            {
              id: '2',
              name: 'Sample Corrugated Supplier 2',
              contactInfo: 'Contact info for supplier 2',
            },
          ],
          pagination: {
            total: 2,
