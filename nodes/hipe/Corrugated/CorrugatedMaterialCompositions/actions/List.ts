...
export async function execute(
  ...
  for (let i = 0; i < items.length; i++) {
    try {
      ...
      // In the actual implementation, this would make an API call to list corrugated material compositions
      ...
      returnData.push({
        json: {
          ...
          data: [
            {
              id: '1',
              corrugatedMaterial: 'sample-material-id-1',
              flute: 'sample-flute-id-1',
              liners: ['sample-liner-id-1', 'sample-liner-id-2'],
            },
            {
              id: '2',
              corrugatedMaterial: 'sample-material-id-2',
              flute: 'sample-flute-id-2',
              liners: ['sample-liner-id-3', 'sample-liner-id-4'],
            },
          ],
          pagination: {
            total: 2,
