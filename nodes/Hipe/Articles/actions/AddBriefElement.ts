...
export async function execute(
	...
	for (let i = 0; i < items.length; i++) {
		try {
			...
			if (lengthDimension) body.lengthDimension = lengthDimension;
			if (widthDimension) body.widthDimension = widthDimension;
			if (heightDimension) body.heightDimension = heightDimension;
